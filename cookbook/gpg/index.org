...
+ Copyright:
  ...
  - SPDX-FileCopyrightText: © 2021-2025 WHK <develop@whk.name>
  - See {{{insertRelativeLink(about/licensing/,Licensing)}}} for more details
+ Author: {{{author}}}
+ Created: {{{date}}}
+ Changes
  - 2021-04-01: Created
  - 2025-12-13: Reorganize into new layout
#+END_details
:END:


* Dependencies and interactions between commands and libraries

A high level view of how the different commands and libraries interact
