...
-  Other settings
   ...
   -  Select advanced page
      ...
      [[file:menuBarAdvanced.png]]

   -  Set advanced as Default

      [[file:defaultPage.png]]

   -  Turn off Hyperthreading

      [[file:hyperThreadingOff.png]]

* Remote config
  :PROPERTIES:
  :CUSTOM_ID: remote-config
  :END:

Setup root SSH to box to be built. Done behind the safety of a NAT
router

-  Boot using [[https://www.gentoo.org/downloads/][Live USB stick]]
   (2014-08-26 Hybrid ISO (LiveDVD) version)
...
* Connect to remote using workstation
  :PROPERTIES:
  :CUSTOM_ID: connect-to-remote-using-workstation
  :END:
...
* Encrypt entire SSD drive [@GentooProjectb]
  :PROPERTIES:
  :CUSTOM_ID: encrypt-entire-ssd-drive-gentooprojectb
  :END:
...
* Configure btrfs filesystems [@Multiplee]
  :PROPERTIES:
  :CUSTOM_ID: configure-btrfs-filesystems-multiplee
  :END:
...
* Mount Drives for installation
  :PROPERTIES:
  :CUSTOM_ID: mount-drives-for-installation
  :END:
...
* Configure for validated portage tree snapshots
  :PROPERTIES:
  :CUSTOM_ID: configure-for-validated-portage-tree-snapshots
  :END:
...
* Configure Timezone and Locale
  :PROPERTIES:
  :CUSTOM_ID: configure-timezone-and-locale
  :END:
...
-  General setup
   ...
   -  Local Version - *20150523-01* where ## is one up number when
